...
// locale — stesso fix già applicato altrove nel progetto.
...
// FIX (29 ago 2026): ora si autoalimenta dal DB,
                  ...
                  <div style={{ marginBottom: '1.25rem', paddingBottom: '1.25rem', borderBottom: borderLine }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'baseline', gap: '0.2rem' }}>
                      ...
                      <span style={{ fontFamily: 'Georgia,serif', fontSize: '2.4rem', color: '#fff', fontWeight: 300, lineHeight: 1 }}>
                        {billingCycle === 'monthly' ? plan.pricePublic : Math.round(plan.pricePublic * 10 / 12)}
                      </span>
                      <span style={{ color: '#57534e', fontSize: '0.85rem' }}>/mo</span>
                    </div>
                    {billingCycle === 'annual' && (
                      <div style={{ fontSize: '0.68rem', color: '#57534e', marginTop: '0.25rem' }}>Addebitato annualmente: €{plan.pricePublic * 10}/anno</div>
                    )}
...
const PLAN_STEPS = [
  { num: '01', title: 'Scegli il Tuo Piano', desc: "Attiva l'abbonamento in pochi minuti. Nessuna carta richiesta per iniziare.", badge: 'Zero attrito', color: '#fbbf24' },
  ...
  { num: '03', title: 'Onboarding Personale con Michael', desc: 'Call 1:1 di 30 minuti. Setup guidato, passo per passo.', badge: 'Incluso', color: '#a855f7' },
];
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          >
            <span className="relative z-10 flex items-center gap-2">
              Inizia Ora <ArrowRight size={18} className="transition-transform group-hover:translate-x-1" />
            </span>
          </a>
    ...
    >
      ...
      <div style={{ position: 'relative' }}>
        ...
        <p style={{ color: '#78716c', fontSize: '0.9rem', marginBottom: '2rem', maxWidth: '30rem', margin: '0 auto 2rem' }}>
          Scarica gratis la nostra guida al setup — passo dopo passo, senza fronzoli.
        </p>
        ...
        <section id="cta-finale" style={{ position: 'relative', padding: '10rem 1.5rem', textAlign: 'center', overflow: 'hidden', borderTop: borderLine }}>
          ...
          <div style={{ position: 'relative', zIndex: 10, maxWidth: '52rem', margin: '0 auto', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            ...
            <motion.p initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.9, delay: 0.15 }}
              ...
              Prezzo pubblico, senza sorprese. Onboarding personale con me. Soddisfatto o rimborsato entro 30 giorni.
            </motion.p>
