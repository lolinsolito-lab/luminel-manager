...
const COLORS = {
  ...
  overlay: "rgba(5, 5, 4, 0.25)", // Mix of black with slight gold tint, significantly reduced opacity for robots
};
  ...
  return (
    <section className="relative min-h-screen w-full overflow-hidden bg-[#050504]">
      ...
      <div className="absolute inset-0">
        ...
        />
        {/* Subtle radial gradient for depth - reduced darkness */}
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-transparent via-[#050504]/20 to-[#050504]/70" />
      </div>
