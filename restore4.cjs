...
// Use the final chunk for PlanSection (STEP 257)
const planChunk = getChunk('const PlanSection: React.FC = () => (\r\n  <section style={{ maxWidth: \'80rem\'');
...
// Note: We need to replace PlanSection entirely but keep PLAN_STEPS!
newLanding = newLanding.replace(
