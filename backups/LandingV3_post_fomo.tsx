...
const QuoteSection: React.FC = () => (
  <section style={{ maxWidth: '64rem', margin: '0 auto', padding: '4rem 1.5rem 6rem', textAlign: 'center' }}>
    ...
    >
      ...
      <a href="#pricing" onClick={(e) => { e.preventDefault(); document.getElementById('pricing')?.scrollIntoView({ behavior: 'smooth' }); }} style={{ display: 'inline-flex', alignItems: 'center', gap: '0.75rem', padding: '1.1rem 3rem', borderRadius: '9999px', border: `1px solid rgba(240,232,210,0.3)`, background: 'rgba(5,5,4,0.6)', backdropFilter: 'blur(20px)', color: '#c8b996', textDecoration: 'none', fontSize: '0.75rem', textTransform: 'uppercase', letterSpacing: '0.18em', boxShadow: `0 0 30px rgba(240,232,210,0.05)`, transition: 'all 0.3s ease' }} className="hover:bg-[#c8b996]/10 hover:scale-105">
