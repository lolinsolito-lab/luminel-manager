...
// 1. Add MichaelStorySection and MetricsGridSection before export default function LandingV2
const newSections = `
...
code = code.replace("export default function LandingV2() {", newSections + "\nexport default function LandingV2() {");

// 2. Inject into the return body of LandingV2
// Place MichaelStorySection after the first <section id="storia">
// Place MetricsGridSection before <PricingSection />
code = code.replace(
  "          <CategoriesSection />",
  "          <MichaelStorySection />\n          <CategoriesSection />"
);
...
// 3. Add Badges to PricingSection
const badgeCode = `
                {p.id === 'pro' && (
...
console.log('Injected new sections successfully.');
